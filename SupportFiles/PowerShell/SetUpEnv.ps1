...
# this project is Elite Dangerous Journal Processing to complement my ED_Enhanced_T16000 TARGET script.
$env:PSModulePath += ";C:\Thrustmaster\ED_TargetScript_T16000\SupportFiles\PowerShell\Modules"
